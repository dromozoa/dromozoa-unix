...
namespace dromozoa {
  ...
  static const int TIMESPEC_TYPE_REALTIME = 1;
  static const int TIMESPEC_TYPE_MONOTONIC = 2;
  static const int TIMESPEC_TYPE_DURATION = 3;
  static const int TIMESPEC_TYPE_UNKNOWN = 4;

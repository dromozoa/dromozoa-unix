...
assert(t:cfsetispeed(t.B9600))
assert(t:cfsetospeed(t.B9600))
write("ispeed: ", t:cfgetispeed(), "\n")
write("ospeed: ", t:cfgetospeed(), "\n")
assert(t:cfgetispeed() == t.B9600)
assert(t:cfgetospeed() == t.B9600)
